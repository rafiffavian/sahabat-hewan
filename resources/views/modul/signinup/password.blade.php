  ...
  <body>
   <div class="container-fluid">
    <div class="row no-gutter">
      ...
      <h1 class="ml4  ml-5">
  <span class="letters letters-1">Hewanku</span>
  <span class="letters letters-2">Sobatku!</span>
  </h1>
<img class="ml-4" style="margin-top: 200px" height="500px" width="auto" src="asset/img/login/login2.png" alt="">
                              ...
                              @csrf
                               ...
                               @endif   
                                ...
                                <div class="form-group mb-3">
                                    <input id="inputEmail" name="password" type="password" placeholder="masukkan password baru" required="" autofocus="" class="form-control rounded-pill border-0 shadow-sm px-4">
                                </div>
