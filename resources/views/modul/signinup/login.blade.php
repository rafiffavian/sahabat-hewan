                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-10 col-xl-7 mx-auto">
                          <img width="80px" height="auto" src="asset/img/logo/dog.png" alt="" class="rounded-circle">
                            ...
                            <form>
                                ...
                                <button type="submit" class="btn btn-success btn-block text-uppercase mb-2 rounded-pill shadow-sm">Sign in</button>
