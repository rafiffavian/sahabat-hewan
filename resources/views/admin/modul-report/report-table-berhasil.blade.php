          ...
          <div class="row">
            <div class="col-md-12">
              ...
              @foreach($report as $reports)
                  <tr>
                  @if($reports->image_one != null)
                    <td><img  width="100"lass="img-fluid" alt="Responsive image" src="{{ url('/') }}/remortimage/{{$reports->image_one}}" /></td>
                  @else 
                    <td><img  width="100"lass="img-fluid" alt="Responsive image" src="{{ url('/') }}/userimage/anon.jpg" /></td> 
                  @endif
